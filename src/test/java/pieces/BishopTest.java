...
public class BishopTest {
    ...
    private final Piece king      = new Piece( Type.KING, Color.BLACK );

    private final Piece blackPawn = new Piece( Type.PAWN, Color.BLACK );
    ...
    @Test
    public void bishopTestWithBlackPieces() {
        board.setPiece( bishop, 1, 3 );
