...
public class MovementBase {
    ...
    public static ArrayList<Tile> getMovements( Board board, Color color,
        ...
        switch ( t ) {
            case PAWN:
                movements = PawnMovement.getAdjacentMoves(
                                                           board, color, row,
                                                           col, attacksOnly );
                break;
            case ROOK:
                movements = HorizontalMovement.getHorizontalMoves(
                                                                   board, row,
                                                                   col,
                                                                   attacksOnly );
                break;
            case KNIGHT:
                ...
                break;
            case BISHOP:
                movements = DiagonalMovement.getDiagonalMoves(
                                                               board, row, col,
                                                               attacksOnly );
                break;
            case KING:
                movements = KingMovement.getKingMoves(
                        board, row, col,
                        attacksOnly );
                break;
            case QUEEN:
                movements = HorizontalMovement.getHorizontalMoves(
                                                                   ...
                                                                   col,
                                                                   attacksOnly );
                movements.addAll( DiagonalMovement.getDiagonalMoves(
                                                                     board,
                                                                     row, col,
                                                                     attacksOnly ) );
                break;
